...
//@TODO generate the following keys from random values on app start
var keys = new Keygrip(['a%2409sfdg;35_ASa', '95Q#$%Wafgklzg+-sdf', '5^%aafdg!!saklxzSA4356']);
...
app.use(function (req, res) {
    ...
    session = cookies.get("ttsession", { signed: true });
    req.session = signed;
});
app.use(session({
